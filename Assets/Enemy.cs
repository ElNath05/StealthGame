...
public class Enemy : MonoBehaviour
{
    ...
    // 플레이어와 벽의 구분을 위해 LayerMask . 를 선언합니다
    ...
    void Update()
    {
        ...
        // 시야 내에 있는 플레이어를 감지합니다 시야 . 내에 플레이어가 있을 경우 플레이어를 List . 에 추가합니다
        if (targets.Length != 0)
        {
    ...
    // Quaternion 적의 방향을 을 이용하여 반환합니다.
    ...
    // GameObject 적이 감지한 를 저장할 List . 입니다
